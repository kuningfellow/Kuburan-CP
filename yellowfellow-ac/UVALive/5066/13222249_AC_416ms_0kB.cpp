    ...
    while (tc--){
        ...
        while (!q.empty()){
            ...
            for (int i=0;i<siz;i++){
                ...
                if (y+1<h&&rem[x][y+1][z]!='X'&&vis[x][y+1][z]==(1<<30)){
                    vis[x][y+1][z]=cost;
                    q.push(triplet(x,y+1,z));
                }
                if (y-1>=0&&rem[x][y-1][z]!='X'&&vis[x][y-1][z]==(1<<30)){
                    vis[x][y-1][z]=cost;
                    q.push(triplet(x,y-1,z));
                }
                if (z+1<w&&rem[x][y][z+1]!='X'&&vis[x][y][z+1]==(1<<30)){
                    vis[x][y][z+1]=cost;
                    q.push(triplet(x,y,z+1));
                }
                if (z-1>=0&&rem[x][y][z-1]!='X'&&vis[x][y][z-1]==(1<<30)){
                    vis[x][y][z-1]=cost;
                    q.push(triplet(x,y,z-1));
                }
                if (rem[x][y][z]=='U'&&vis[x+1][y][z]==(1<<30)){
                    vis[x+1][y][z]=cost;
                    q.push(triplet(x+1,y,z));
                }
                if (rem[x][y][z]=='D'&&vis[x-1][y][z]==(1<<30)){
                    vis[x-1][y][z]=cost;
                    q.push(triplet(x-1,y,z));
                }
                q.pop();
